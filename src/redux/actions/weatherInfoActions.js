...
export const getWeatherInfo = () => async (dispatch) => {
    ...
    const url = process.env.REACT_APP_OPEN_WEATHER_MAP_URL || "https://api.openweathermap.org/data/2.5/forecast?q=Munich,de&APPID=75f972b80e26f14fe6c920aa6a85ad57&cnt=40";
    return fetch(url)
